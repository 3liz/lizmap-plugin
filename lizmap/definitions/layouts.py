...
class LayoutsDefinitions(BaseDefinitions):
    def __init__(self):
        ...
        self._layer_config["allowed_groups"] = {
            ...
            "use_json": True,
            "tooltip": tr(
                "Use a comma separated list of Lizmap groups ids to restrict access to this layer edition."
            ),
        }
        self._layer_config["formats_available"] = {
            ...
            "default": (
                "pdf",
            ),  # This value is overriden if the legacy checkbox was used adding all other formats.
