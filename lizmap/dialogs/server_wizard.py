...
class ServerWizard(QWizard):
    ...
    def save_pg(self) -> bool:
        ...
        settings.setValue('PostgreSQL/connections/{}/estimatedMetadata'.format(name), 'true')
        settings.setValue('PostgreSQL/connections/{}/geometryColumnsOnly'.format(name), 'false')
        settings.setValue('PostgreSQL/connections/{}/projectsInDatabase'.format(name), 'false')
        settings.setValue('PostgreSQL/connections/{}/publicOnly'.format(name), 'false')
        settings.setValue('PostgreSQL/connections/{}/savePassword'.format(name), 'true')
        settings.setValue('PostgreSQL/connections/{}/saveUsername'.format(name), 'true')
