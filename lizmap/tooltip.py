...
from .toolbelt.resources import _N
...
class Tooltip:
    ...
    # BEWARE : we must keep it in lizmap-plugin file
    # but not in qgis-lizmap-server-plugin file since LWC already provides the correct CSS
    css_3_8_6 = """<style>
