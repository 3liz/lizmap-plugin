...
@pytest.mark.skipif(
    ...
    reason="No PG configuration defined",
)
class TestSql(TestCase):
    schema = "lizmap_plugin_tests"
    ...
    def _create_views(self, table_name: str, cursor, connection):
    ...
    def test_invalid_auto_generated_pk(self, cursor, connection):
        ...
        self._create_views(table_name, cursor, connection)
    ...
    def test_invalid_varchar_pk(self, cursor, connection):
    ...
    def test_invalid_int8_pk(self, cursor, connection):
    ...
    def test_invalid_composite_pk(self, cursor, connection):
    ...
    def test_valid_serial_pk(self, cursor, connection):
        ...
        self.assertEqual(
            field_name,
            layer_materialized_view.fields().at(layer_materialized_view.primaryKeyAttributes()[0]).name(),
        )
        new_uri = QgsDataSourceUri(layer_materialized_view.source())
        self.assertEqual(field_name, new_uri.keyColumn())
    ...
    def test_valid_smallint_pk(self, cursor, connection):
    ...
    def test_detect_view(self, cursor, connection):
        ...
        self.assertEqual(
            QgsAbstractDatabaseProviderConnection.TableFlag.Vector, table_type(self._vector_layer(table_name))
        )
        self.assertEqual(
