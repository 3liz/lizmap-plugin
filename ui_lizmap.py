...
#
# Created: Wed Sep 19 15:50:32 2012
...
class Ui_lizmap(object):
    def setupUi(self, lizmap):
        ...
        self.gridLayout.addWidget(self.btHelp, 2, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.lbWinscpHelp, 6, 0, 1, 1)
        ...
        self.gridLayout_10.addLayout(self.horizontalLayout_10, 4, 0, 1, 1)
        ...
        lizmap.setTabOrder(self.btCancelFtpSync, self.inWinscpPath)
        lizmap.setTabOrder(self.inWinscpPath, self.buttonClose)
        lizmap.setTabOrder(self.buttonClose, self.btHelp)
        lizmap.setTabOrder(self.btHelp, self.btSave)
